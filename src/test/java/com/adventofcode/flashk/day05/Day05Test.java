...
class Day05Test {
	...
	void part1SampleTest() {
        ...
        Cafeteria cafeteria = new Cafeteria(inputs);
        long result = cafeteria.solveA();
	...
	void part2InputTest() {
		...
		assertEquals(360341832208407L,result);
